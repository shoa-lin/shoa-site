...
- **Les ingénieurs** peuvent désormais ajouter une mémoire persistante en un après-midi. Le [guide d'auto-hébergement de Mem0 avec Docker](https://mem0.ai/blog/self-host-mem0-docker) utilise Qdrant comme backend vectoriel et permet d'obtenir une API locale fonctionnelle en moins de 20 minutes.
